...
@section('content')
<div class="container">
    <a href="{{ route('reports.index') }}" class="btn btn-dark btn-lg">  <i class="bi bi-arrow-left"></i> Volver
    </a>
    ...
    <div style="text-align: right; margin-top: 20px;">
        <a href="{{ route('reports.commissions.pdf') }}" class="btn btn-outline-primary">
            Generar PDF
        </a>
    </div>
</div>
