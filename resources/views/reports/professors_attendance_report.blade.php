...
@section('content')
<div class="container">
<a href="{{ route('reports.index') }}" class="btn btn-dark btn-lg">  <i class="bi bi-arrow-left"></i> Volver</a>
    ...
    <div class="text-center mt-4">
        <a href="{{ route('reports.professors.pdf') }}" class="btn btn-outline-primary">
            Generar PDF
        </a>
    </div>
</div>
